...
@Entity
public class KYCPresentAddressBox implements Serializable {
    ...
    public KYCPresentAddressBox() {
    }

    public KYCPresentAddressBox(KYCDMNew.PresentAddress data) {
        ...
        this.is_owner = data.getIS_OWNER();
        this.duration_liveshere = data.getDURATION_LIVESHERE();
    ...
    public String toString() {
        return "KYCPresentAddressBox{" +
                ...
                ", district='" + district + '\'' +
                ", is_owner=" + is_owner +
                ", duration_liveshere=" + duration_liveshere +
                ", member_id='" + member_id + '\'' +
                ", center_id='" + center_id + '\'' +
                ", branch_id='" + branch_id + '\'' +
                '}';
